...
export class SecretPlot {
  ...
  constructor(public plotName: string, public latitude: number, public longitude: number, public description: string, public plotSize: string, public produce: string[], public blog: any) {}
